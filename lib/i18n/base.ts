export const en = {
  ...
  profileLoginHint: 'Log in with an email code or Google. Phone is kept for payments.',
  logIn: 'Log In',
  ...
  emailOtpCode: 'Email code',
  emailOtpPlaceholder: '6-digit code',
  emailOtpHelp: 'Enter the code we sent to your email.',
  emailOtpSent: 'Code sent. Please check your email.',
  emailOtpRequired: 'Enter the email code first.',
  emailOtpResend: 'Send another code',
  sendLoginCode: 'Send Email Code',
  verifyLoginCode: 'Verify Code',
