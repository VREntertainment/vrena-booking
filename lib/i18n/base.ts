export const en = {
  ...
  clubDefaultRanking: 'Default VRena ranking is active.',
  clubCustomRankingHint: 'Custom club rankings are ready for future expansion. For now, the main Hall of Fame rules keep the crown honest.',
  noClub: 'No club',
