export const en = {
  ...
  ticketLoyaltyEarnEstimate: 'This ticket earns {points} points after payment is confirmed, worth {value} next time.',
  ticketLoyaltyEarnZero: 'This ticket earns 0 points with the current settings. Tweak the booking and this tiny counter follows.',
