...
import { Check, Download, FileSpreadsheet, FileText, Plus, Save, X } from 'lucide-react'
...
export default function StaffHrHub({ model }: StaffHrHubProps) {
  ...
  return (
        <div className="staff-card staff-card-wide staff-hr-card">
          {visibleAllStaffProfileOptions.length === 0 ? (
            ...
            <>
              ...
              <div className="staff-summary-grid staff-attendance-summary staff-hr-summary">
                <div><span>{text.hrTabs.employees}</span><strong>{visibleAllStaffProfileOptions.length}</strong></div>
              ...
              <div className="staff-commerce-switcher staff-attendance-tabs staff-hr-tabs" role="tablist" aria-label="HR">
