...
const returnMissionCopy: Record<LanguageCode, ReturnMissionCopy> = {
  en: {
    ...
    fromCollection: 'Achievement Collection',
  ...
  vi: {
    ...
    fromCollection: 'Bộ sưu tập thành tích',
