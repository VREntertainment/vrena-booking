...
function arenasUsedBySession(session: Pick<Session, 'max_players'>) {
  return session.max_players > 4 ? 2 : 1
}
...
export default function WidgetPage() {
  ...
  const timeOptions = useMemo(() => {
    ...
    return options
  }, [blockedTimes, sessionDate, sessionDuration, sessions])
                  ...
                  <article className="session" key={session.id}>
                    ...
                    <div className="game-strip">
                      {session.game_options.map((gameId) => {
                        ...
                        return (
                          <button
                            className={session.game_votes?.[userId] === gameId ? 'game-card selected' : 'game-card'}
                            key={gameId}
          ...
          <section className="section">
            ...
            <div className="form-grid">
              ...
              <div>
                ...
                <select value={sessionMaxPlayers} onChange={(event) => setSessionMaxPlayers(Number(event.target.value))}>
          ...
          <section className="section">
            ...
            <div className="form-grid profile-form">
              <div>
                ...
                <input value={profilePhone} onChange={(event) => setProfilePhone(event.target.value)} placeholder="+84..." />
              </div>
              <div>
            ...
            <button className="primary create-button" onClick={saveProfile}>Save Profile</button>
