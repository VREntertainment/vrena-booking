...
const requiredOfficialTokens = [
  ...
  '--vrena-cta-primary: var(--vrena-cta-gradient-warm)',
  '--vrena-cta-primary-hover: linear-gradient(90deg, color-mix(in srgb, #ffb800 92%, var(--vrena-neutral-950)) 0%, color-mix(in srgb, #fd5901 92%, var(--vrena-neutral-950)) 100%)',
  '--vrena-cta-primary-pressed: linear-gradient(90deg, color-mix(in srgb, #ffb800 84%, var(--vrena-neutral-950)) 0%, color-mix(in srgb, #fd5901 84%, var(--vrena-neutral-950)) 100%)',
