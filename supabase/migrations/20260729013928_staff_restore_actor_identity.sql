create or replace function public.get_soft_deleted_records_v2(p_limit integer default 100)
returns table (
  entity_table text,
  entity_id uuid,
  label text,
...
revoke all on function public.get_soft_deleted_records_v2(integer) from public, anon;
grant execute on function public.get_soft_deleted_records_v2(integer) to authenticated, service_role;
